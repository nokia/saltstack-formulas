...
Running Cassandra Mesos framework
...
cassandra-mesos:
  ...
  uris:
    - salt://.../cassandra-mesos-executor.jar
    - salt://.../cassandra-mesos-framework.jar
    - salt://.../jre-7u76-linux-x64.tar.gz
    - salt://.../apache-cassandra-2.1.4-bin.tar.gz
  healthChecks:
